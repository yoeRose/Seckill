...
public enum StatusUtil {
    ...
    //登录模块
    SESSION_ERROR("session不存在或者错误",500209),
    PASSWORD_EMPTY("密码不能为空",500210),
    MOBILE_EMPTY("电话号码不能为空",500211),
    MOBILE_ERROR("电话号码格式错误",500212),
    MOBILE_NOT_EXIST("电话号码不存在",500213),
    PASSWORD_ERROR("密码错误",500214);
